...
class UserTimelineTest {
    ...
    void setUp() throws JSONException, TwitterException {
        userTimelineInstance = createMock(UserTimeline.class);
    ...
    @Test
    void getTimeline() {
        EasyMock.expect(userTimelineInstance.GetTimeline(twitterInstance)).andReturn(responseList).anyTimes();
        EasyMock.replay(userTimelineInstance);
