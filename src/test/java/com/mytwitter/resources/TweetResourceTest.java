...
public class TweetResourceTest {
    ...
    @Before
    public void setup() throws JSONException, TwitterException {
        tweetResource = createMock(TweetResource.class);
    ...
    public void testGetTweets(){
        EasyMock.expect(tweetResource.getTweets()).andReturn(responseList).anyTimes();
        EasyMock.replay(tweetResource);
        ResponseList<Status> actualResponseList = tweetResource.getTweets();
        assertEquals(true,actualResponseList.equals(responseList));
    }

    @Test
    public void testPostTweetWithoutException() throws TwitterException {
        String tweet = "Hi, This is my post tweet";
        EasyMock.expect(tweetResource.postTweet(tweet)).andReturn(true).anyTimes();
        EasyMock.replay(tweetResource);
        boolean actualResponse = tweetResource.postTweet(tweet);
        assertEquals(true,actualResponse);
    }

    @Test()
    public void testPostTweetWithException(){
        String tweet = "Hi, This is my post tweet";
        EasyMock.expect(tweetResource.postTweet(tweet)).andReturn(false).anyTimes();
        EasyMock.replay(tweetResource);
        boolean actualResponse = tweetResource.postTweet(tweet);
